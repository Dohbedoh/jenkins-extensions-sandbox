package jenkins.plugins.myplugin.notifier;
 ...
 */
public class MyNotifierExtension extends Notifier {

    private static final Logger LOGGER = Logger.getLogger(MyNotifierExtension.class.getName());
    public final String tagName;
    public final Set<Result> resultsToDiscard;

    @DataBoundConstructor
    public MyNotifierExtension(
            String tagName,
    ...
    public BuildStepMonitor getRequiredMonitorService() {
        /**
         * TODO: play with other {@link BuildStepMonitor} to understand the difference.
         */
    ...
    public static class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        ...
        public String getDisplayName() {
            return Messages.MyNotifierExtension_DisplayName();
        }
    }
}
